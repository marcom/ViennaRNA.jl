...
const VERSION_GEN_Clang = v"0.18.1"
...
"""
const vrna_sc_motif_t = vrna_sc_motif_s

"""
    vrna_sc_add_hi_motif(fc, seq, structure, energy, options)
...
```
"""
function vrna_sc_add_hi_motif(fc, seq, structure, energy, options)
    ccall((:vrna_sc_add_hi_motif, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}, Ptr{Cchar}, FLT_OR_DBL, Cuint), fc, seq, structure, energy, options)
end

"""
    vrna_sc_ligand_detect_motifs(fc, structure)
...
```
"""
function vrna_sc_ligand_detect_motifs(fc, structure)
    ccall((:vrna_sc_ligand_detect_motifs, libRNA), Ptr{vrna_sc_motif_t}, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}), fc, structure)
end

"""
    vrna_sc_ligand_get_all_motifs(fc)
...
```
"""
function vrna_sc_ligand_get_all_motifs(fc)
    ccall((:vrna_sc_ligand_get_all_motifs, libRNA), Ptr{vrna_sc_motif_t}, (Ptr{vrna_fold_compound_t},), fc)
end

"""
    vrna_constraints_add_SHAPE(fc, shape_file, shape_method, shape_conversion, verbose, constraint_type)
...
```
"""
function vrna_constraints_add_SHAPE(fc, shape_file, shape_method, shape_conversion, verbose, constraint_type)
    ccall((:vrna_constraints_add_SHAPE, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cchar}, Cint, Cuint), fc, shape_file, shape_method, shape_conversion, verbose, constraint_type)
end

"""
    vrna_constraints_add_SHAPE_ali(fc, shape_method, shape_files, shape_file_association, verbose, constraint_type)
...
```
"""
function vrna_constraints_add_SHAPE_ali(fc, shape_method, shape_files, shape_file_association, verbose, constraint_type)
    ccall((:vrna_constraints_add_SHAPE_ali, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}, Ptr{Ptr{Cchar}}, Ptr{Cint}, Cint, Cuint), fc, shape_method, shape_files, shape_file_association, verbose, constraint_type)
end

"""
    vrna_sc_add_SHAPE_deigan(fc, reactivities, m, b, options)
...
```
"""
function vrna_sc_add_SHAPE_deigan(fc, reactivities, m, b, options)
    ccall((:vrna_sc_add_SHAPE_deigan, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cdouble}, Cdouble, Cdouble, Cuint), fc, reactivities, m, b, options)
end

"""
    vrna_sc_add_SHAPE_deigan_ali(fc, shape_files, shape_file_association, m, b, options)
...
```
"""
function vrna_sc_add_SHAPE_deigan_ali(fc, shape_files, shape_file_association, m, b, options)
    ccall((:vrna_sc_add_SHAPE_deigan_ali, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Ptr{Cchar}}, Ptr{Cint}, Cdouble, Cdouble, Cuint), fc, shape_files, shape_file_association, m, b, options)
end

"""
    vrna_sc_add_SHAPE_zarringhalam(fc, reactivities, b, default_value, shape_conversion, options)
...
```
"""
function vrna_sc_add_SHAPE_zarringhalam(fc, reactivities, b, default_value, shape_conversion, options)
    ccall((:vrna_sc_add_SHAPE_zarringhalam, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cdouble}, Cdouble, Cdouble, Ptr{Cchar}, Cuint), fc, reactivities, b, default_value, shape_conversion, options)
end

"""
    vrna_sc_SHAPE_parse_method(method_string, method, param_1, param_2)
...
```
"""
function vrna_sc_SHAPE_parse_method(method_string, method, param_1, param_2)
    ccall((:vrna_sc_SHAPE_parse_method, libRNA), Cint, (Ptr{Cchar}, Ptr{Cchar}, Ptr{Cfloat}, Ptr{Cfloat}), method_string, method, param_1, param_2)
end

"""
    vrna_sc_SHAPE_to_pr(shape_conversion, values, length, default_value)
...
```
"""
function vrna_sc_SHAPE_to_pr(shape_conversion, values, length, default_value)
    ccall((:vrna_sc_SHAPE_to_pr, libRNA), Cint, (Ptr{Cchar}, Ptr{Cdouble}, Cint, Cdouble), shape_conversion, values, length, default_value)
end
...
mutable struct vrna_sc_mod_param_s end
...
"""
 ...
 @see  vrna_sc_mod_read_from_jsonfile(), vrna_sc_mod_read_from_json(),
       vrna_sc_mod()
"""
const vrna_sc_mod_param_t = Ptr{vrna_sc_mod_param_s}

"""
    vrna_sc_mod_read_from_jsonfile(filename, md)
...
```
"""
function vrna_sc_mod_read_from_jsonfile(filename, md)
    ccall((:vrna_sc_mod_read_from_jsonfile, libRNA), vrna_sc_mod_param_t, (Ptr{Cchar}, Ptr{vrna_md_t}), filename, md)
end

"""
    vrna_sc_mod_read_from_json(json, md)
...
```
"""
function vrna_sc_mod_read_from_json(json, md)
    ccall((:vrna_sc_mod_read_from_json, libRNA), vrna_sc_mod_param_t, (Ptr{Cchar}, Ptr{vrna_md_t}), json, md)
end
...
```
"""
function vrna_sc_mod_parameters_free(params)
    ccall((:vrna_sc_mod_parameters_free, libRNA), Cvoid, (vrna_sc_mod_param_t,), params)
end

"""
    vrna_sc_mod_json(fc, json, modification_sites, options)
...
```
"""
function vrna_sc_mod_json(fc, json, modification_sites, options)
    ccall((:vrna_sc_mod_json, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}, Ptr{Cuint}, Cuint), fc, json, modification_sites, options)
end

"""
    vrna_sc_mod_jsonfile(fc, json_file, modification_sites, options)
...
```
"""
function vrna_sc_mod_jsonfile(fc, json_file, modification_sites, options)
    ccall((:vrna_sc_mod_jsonfile, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cchar}, Ptr{Cuint}, Cuint), fc, json_file, modification_sites, options)
end

"""
    vrna_sc_mod(fc, params, modification_sites, options)
...
```
"""
function vrna_sc_mod(fc, params, modification_sites, options)
    ccall((:vrna_sc_mod, libRNA), Cint, (Ptr{vrna_fold_compound_t}, vrna_sc_mod_param_t, Ptr{Cuint}, Cuint), fc, params, modification_sites, options)
end

"""
    vrna_sc_mod_m6A(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_m6A(fc, modification_sites, options)
    ccall((:vrna_sc_mod_m6A, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end

"""
    vrna_sc_mod_pseudouridine(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_pseudouridine(fc, modification_sites, options)
    ccall((:vrna_sc_mod_pseudouridine, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end

"""
    vrna_sc_mod_inosine(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_inosine(fc, modification_sites, options)
    ccall((:vrna_sc_mod_inosine, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end

"""
    vrna_sc_mod_7DA(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_7DA(fc, modification_sites, options)
    ccall((:vrna_sc_mod_7DA, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end

"""
    vrna_sc_mod_purine(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_purine(fc, modification_sites, options)
    ccall((:vrna_sc_mod_purine, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end

"""
    vrna_sc_mod_dihydrouridine(fc, modification_sites, options)
...
```
"""
function vrna_sc_mod_dihydrouridine(fc, modification_sites, options)
    ccall((:vrna_sc_mod_dihydrouridine, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cuint}, Cuint), fc, modification_sites, options)
end
...
const VRNA_SC_MOD_CHECK_FALLBACK = 1

const VRNA_SC_MOD_CHECK_UNMOD = 2

const VRNA_SC_MOD_SILENT = 4

const VRNA_SC_MOD_DEFAULT = VRNA_SC_MOD_CHECK_FALLBACK | VRNA_SC_MOD_CHECK_UNMOD
