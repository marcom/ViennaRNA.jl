...
const VERSION_GEN_Clang = v"0.17.1"
const VERSION_GEN_ViennaRNA_jll = v"2.5.1+1"
...
struct vrna_hc_s
    ...
    up_int::Ptr{Cint}
    up_ml::Ptr{Cint}
    f::Ptr{vrna_callback_hc_evaluate}
    data::Ptr{Cvoid}
    free_data::Ptr{vrna_callback_free_auxdata}
...
struct vrna_unstructured_domain_s
    ...
    prod_cb::Ptr{vrna_callback_ud_production}
    exp_prod_cb::Ptr{vrna_callback_ud_exp_production}
    energy_cb::Ptr{vrna_callback_ud_energy}
    exp_energy_cb::Ptr{vrna_callback_ud_exp_energy}
    data::Ptr{Cvoid}
    free_data::Ptr{vrna_callback_free_auxdata}
    probs_add::Ptr{vrna_callback_ud_probs_add}
    probs_get::Ptr{vrna_callback_ud_probs_get}
end
...
struct vrna_gr_aux_s
    cb_proc::Ptr{vrna_callback_gr_cond}
    cb_aux_f::Ptr{vrna_callback_gr_rule}
    cb_aux_c::Ptr{vrna_callback_gr_rule}
    cb_aux_m::Ptr{vrna_callback_gr_rule}
    cb_aux_m1::Ptr{vrna_callback_gr_rule}
    cb_aux::Ptr{vrna_callback_gr_rule_aux}
    cb_aux_exp_f::Ptr{vrna_callback_gr_rule_exp}
    cb_aux_exp_c::Ptr{vrna_callback_gr_rule_exp}
    cb_aux_exp_m::Ptr{vrna_callback_gr_rule_exp}
    cb_aux_exp_m1::Ptr{vrna_callback_gr_rule_exp}
    cb_aux_exp::Ptr{vrna_callback_gr_rule_aux_exp}
    data::Ptr{Cvoid}
    free_data::Ptr{vrna_callback_gr_free_data}
end
...
struct vrna_sc_s
    ...
    f::Ptr{vrna_callback_sc_energy}
    bt::Ptr{vrna_callback_sc_backtrack}
    exp_f::Ptr{vrna_callback_sc_exp_energy}
    data::Ptr{Cvoid}
    free_data::Ptr{vrna_callback_free_auxdata}
end
...
struct vrna_fc_s
    ...
    iindx::Ptr{Cint}
    jindx::Ptr{Cint}
    stat_cb::Ptr{vrna_callback_recursion_status}
    auxdata::Ptr{Cvoid}
    free_auxdata::Ptr{vrna_callback_free_auxdata}
...
"""
    vrna_exp_params_subst(vc, params)
...
### Prototype
```c
void vrna_params_prepare(vrna_fold_compound_t *vc, unsigned int options);
```
"""
...
"""
    vrna_mx_mfe_add(vc, mx_type, options)


### Prototype
```c
int vrna_mx_mfe_add(vrna_fold_compound_t *vc, vrna_mx_type_e mx_type, unsigned int options);
```
"""
...
"""
    vrna_mx_pf_add(vc, mx_type, options)


### Prototype
```c
int vrna_mx_pf_add(vrna_fold_compound_t *vc, vrna_mx_type_e mx_type, unsigned int options);
```
"""
...
### Prototype
```c
int vrna_mx_prepare(vrna_fold_compound_t *vc, unsigned int options);
```
"""
...
"""
    vrna_constraints_add(vc, constraint, options)
...
"""
    vrna_hc_add_up_batch(vc, constraints)
...
"""
    vrna_hc_add_bp_nonspecific(vc, i, d, option)
...
function vrna_hc_add_f(vc, f)
    ccall((:vrna_hc_add_f, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_hc_evaluate}), vc, f)
end

"""
    vrna_hc_add_data(vc, data, f)
...
function vrna_hc_add_data(vc, data, f)
    ccall((:vrna_hc_add_data, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{Cvoid}, Ptr{vrna_callback_free_auxdata}), vc, data, f)
end
...
### Prototype
```c
void vrna_sc_prepare(vrna_fold_compound_t *vc, unsigned int options);
```
"""
...
"""
    vrna_sc_update(vc, i, options)


### Prototype
```c
int vrna_sc_update(vrna_fold_compound_t *vc, unsigned int i, unsigned int options);
```
"""
...
"""
    vrna_sc_set_bp(vc, constraints, options)
...
"""
    vrna_sc_add_bp(vc, i, j, energy, options)
...
"""
    vrna_sc_set_up(vc, constraints, options)
...
"""
    vrna_sc_add_up(vc, i, energy, options)
...
"""
    vrna_sc_set_stack(vc, constraints, options)


### Prototype
```c
int vrna_sc_set_stack(vrna_fold_compound_t *vc, const FLT_OR_DBL *constraints, unsigned int options);
```
"""
...
"""
    vrna_sc_add_stack(vc, i, energy, options)


### Prototype
```c
int vrna_sc_add_stack(vrna_fold_compound_t *vc, int i, FLT_OR_DBL energy, unsigned int options);
```
"""
...
"""
    vrna_sc_add_data(vc, data, free_data)
...
function vrna_sc_add_data(vc, data, free_data)
    ccall((:vrna_sc_add_data, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cvoid}, Ptr{vrna_callback_free_auxdata}), vc, data, free_data)
end

"""
    vrna_sc_add_data_comparative(vc, data, free_data)
...
function vrna_sc_add_data_comparative(vc, data, free_data)
    ccall((:vrna_sc_add_data_comparative, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{vrna_callback_free_auxdata}}), vc, data, free_data)
end
...
function vrna_sc_add_f(vc, f)
    ccall((:vrna_sc_add_f, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_sc_energy}), vc, f)
end

"""
    vrna_sc_add_f_comparative(vc, f)


### Prototype
```c
int vrna_sc_add_f_comparative(vrna_fold_compound_t *vc, vrna_callback_sc_energy **f);
```
"""
function vrna_sc_add_f_comparative(vc, f)
    ccall((:vrna_sc_add_f_comparative, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Ptr{vrna_callback_sc_energy}}), vc, f)
end
...
function vrna_sc_add_bt(vc, f)
    ccall((:vrna_sc_add_bt, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_sc_backtrack}), vc, f)
end

"""
    vrna_sc_add_exp_f(vc, exp_f)
...
function vrna_sc_add_exp_f(vc, exp_f)
    ccall((:vrna_sc_add_exp_f, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_sc_exp_energy}), vc, exp_f)
end

"""
    vrna_sc_add_exp_f_comparative(vc, exp_f)


### Prototype
```c
int vrna_sc_add_exp_f_comparative(vrna_fold_compound_t *vc, vrna_callback_sc_exp_energy **exp_f);
```
"""
function vrna_sc_add_exp_f_comparative(vc, exp_f)
    ccall((:vrna_sc_add_exp_f_comparative, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Ptr{vrna_callback_sc_exp_energy}}), vc, exp_f)
end
...
### Prototype
```c
int vrna_gr_set_aux_f(vrna_fold_compound_t *fc, vrna_callback_gr_rule *cb);
```
"""
function vrna_gr_set_aux_f(fc, cb)
    ccall((:vrna_gr_set_aux_f, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_exp_f(vrna_fold_compound_t *fc, vrna_callback_gr_rule_exp *cb);
```
"""
function vrna_gr_set_aux_exp_f(fc, cb)
    ccall((:vrna_gr_set_aux_exp_f, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_exp}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_c(vrna_fold_compound_t *fc, vrna_callback_gr_rule *cb);
```
"""
function vrna_gr_set_aux_c(fc, cb)
    ccall((:vrna_gr_set_aux_c, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_exp_c(vrna_fold_compound_t *fc, vrna_callback_gr_rule_exp *cb);
```
"""
function vrna_gr_set_aux_exp_c(fc, cb)
    ccall((:vrna_gr_set_aux_exp_c, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_exp}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_m(vrna_fold_compound_t *fc, vrna_callback_gr_rule *cb);
```
"""
function vrna_gr_set_aux_m(fc, cb)
    ccall((:vrna_gr_set_aux_m, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_exp_m(vrna_fold_compound_t *fc, vrna_callback_gr_rule_exp *cb);
```
"""
function vrna_gr_set_aux_exp_m(fc, cb)
    ccall((:vrna_gr_set_aux_exp_m, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_exp}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_m1(vrna_fold_compound_t *fc, vrna_callback_gr_rule *cb);
```
"""
function vrna_gr_set_aux_m1(fc, cb)
    ccall((:vrna_gr_set_aux_m1, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_exp_m1(vrna_fold_compound_t *fc, vrna_callback_gr_rule_exp *cb);
```
"""
function vrna_gr_set_aux_exp_m1(fc, cb)
    ccall((:vrna_gr_set_aux_exp_m1, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_exp}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux(vrna_fold_compound_t *fc, vrna_callback_gr_rule_aux *cb);
```
"""
function vrna_gr_set_aux(fc, cb)
    ccall((:vrna_gr_set_aux, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_aux}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_aux_exp(vrna_fold_compound_t *fc, vrna_callback_gr_rule_aux_exp *cb);
```
"""
function vrna_gr_set_aux_exp(fc, cb)
    ccall((:vrna_gr_set_aux_exp, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_rule_aux_exp}), fc, cb)
end
...
### Prototype
```c
int vrna_gr_set_data(vrna_fold_compound_t *fc, void *data, vrna_callback_gr_free_data *free_data);
```
"""
function vrna_gr_set_data(fc, data, free_data)
    ccall((:vrna_gr_set_data, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cvoid}, Ptr{vrna_callback_gr_free_data}), fc, data, free_data)
end
...
### Prototype
```c
int vrna_gr_set_cond(vrna_fold_compound_t *fc, vrna_callback_gr_cond *cb);
```
"""
function vrna_gr_set_cond(fc, cb)
    ccall((:vrna_gr_set_cond, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_gr_cond}), fc, cb)
end
...
"""
    vrna_plist_from_probs(vc, cut_off)
...
"""
    vrna_ud_add_motif(vc, motif, motif_en, motif_name, loop_type)
...
"""
    vrna_ud_get_motif_size_at(vc, i, loop_type)
...
"""
    vrna_ud_get_motifs_at(vc, i, loop_type)


### Prototype
```c
int * vrna_ud_get_motifs_at(vrna_fold_compound_t *vc, int i, unsigned int loop_type);
```
"""
...
"""
    vrna_ud_detect_motifs(vc, structure)


### Prototype
```c
vrna_ud_motif_t * vrna_ud_detect_motifs(vrna_fold_compound_t *vc, const char *structure);
```
"""
...
"""
    vrna_ud_set_data(vc, data, free_cb)
...
function vrna_ud_set_data(vc, data, free_cb)
    ccall((:vrna_ud_set_data, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{Cvoid}, Ptr{vrna_callback_free_auxdata}), vc, data, free_cb)
end

"""
    vrna_ud_set_prod_rule_cb(vc, pre_cb, e_cb)
...
function vrna_ud_set_prod_rule_cb(vc, pre_cb, e_cb)
    ccall((:vrna_ud_set_prod_rule_cb, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_ud_production}, Ptr{vrna_callback_ud_energy}), vc, pre_cb, e_cb)
end

"""
    vrna_ud_set_exp_prod_rule_cb(vc, pre_cb, exp_e_cb)
...
function vrna_ud_set_exp_prod_rule_cb(vc, pre_cb, exp_e_cb)
    ccall((:vrna_ud_set_exp_prod_rule_cb, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_ud_exp_production}, Ptr{vrna_callback_ud_exp_energy}), vc, pre_cb, exp_e_cb)
end

"""
    vrna_ud_set_prob_cb(vc, setter, getter)
...
function vrna_ud_set_prob_cb(vc, setter, getter)
    ccall((:vrna_ud_set_prob_cb, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_ud_probs_add}, Ptr{vrna_callback_ud_probs_get}), vc, setter, getter)
end
...
function vrna_fold_compound_add_auxdata(fc, data, f)
    ccall((:vrna_fold_compound_add_auxdata, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{Cvoid}, Ptr{vrna_callback_free_auxdata}), fc, data, f)
end
...
function vrna_fold_compound_add_callback(fc, f)
    ccall((:vrna_fold_compound_add_callback, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Ptr{vrna_callback_recursion_status}), fc, f)
end
...
function vrna_heat_capacity_cb(fc, T_min, T_max, T_increment, mpoints, cb, data)
    ccall((:vrna_heat_capacity_cb, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Cfloat, Cfloat, Cfloat, Cuint, Ptr{vrna_heat_capacity_callback}, Ptr{Cvoid}), fc, T_min, T_max, T_increment, mpoints, cb, data)
end
...
"""
    vrna_neighbors_successive(vc, curr_move, prev_pt, prev_neighbors, size_prev_neighbors, size_neighbors, options)
...
function vrna_move_neighbor_diff_cb(fc, ptable, move, cb, data, options)
    ccall((:vrna_move_neighbor_diff_cb, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Ptr{Cshort}, vrna_move_t, Ptr{vrna_callback_move_update}, Ptr{Cvoid}, Cuint), fc, ptable, move, cb, data, options)
end
...
"""
    vrna_backtrack_from_intervals(vc, bp_stack, bt_stack, s)

 @brief
### Prototype
```c
int vrna_backtrack_from_intervals(vrna_fold_compound_t *vc, vrna_bp_stack_t *bp_stack, sect bt_stack[], int s);
```
"""
...
function vrna_mfe_window_cb(vc, cb, data)
    ccall((:vrna_mfe_window_cb, libRNA), Cfloat, (Ptr{vrna_fold_compound_t}, Ptr{vrna_mfe_window_callback}, Ptr{Cvoid}), vc, cb, data)
end
...
function vrna_Lfold_cb(string, window_size, cb, data)
    ccall((:vrna_Lfold_cb, libRNA), Cfloat, (Ptr{Cchar}, Cint, Ptr{vrna_mfe_window_callback}, Ptr{Cvoid}), string, window_size, cb, data)
end
...
function vrna_aliLfold_cb(alignment, maxdist, cb, data)
    ccall((:vrna_aliLfold_cb, libRNA), Cfloat, (Ptr{Ptr{Cchar}}, Cint, Ptr{vrna_mfe_window_callback}, Ptr{Cvoid}), alignment, maxdist, cb, data)
end
...
function vrna_pbacktrack5_cb(fc, num_samples, length, cb, data, options)
    ccall((:vrna_pbacktrack5_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Cuint), fc, num_samples, length, cb, data, options)
end

"""
    vrna_pbacktrack5_resume(vc, num_samples, length, nr_mem, options)
...
function vrna_pbacktrack5_resume_cb(fc, num_samples, length, cb, data, nr_mem, options)
    ccall((:vrna_pbacktrack5_resume_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Ptr{vrna_pbacktrack_mem_t}, Cuint), fc, num_samples, length, cb, data, nr_mem, options)
end
...
function vrna_pbacktrack_cb(fc, num_samples, cb, data, options)
    ccall((:vrna_pbacktrack_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Cuint), fc, num_samples, cb, data, options)
end
...
function vrna_pbacktrack_resume_cb(fc, num_samples, cb, data, nr_mem, options)
    ccall((:vrna_pbacktrack_resume_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Ptr{vrna_pbacktrack_mem_t}, Cuint), fc, num_samples, cb, data, nr_mem, options)
end
...
function vrna_pbacktrack_sub_cb(fc, num_samples, start, _end, cb, data, options)
    ccall((:vrna_pbacktrack_sub_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Cuint, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Cuint), fc, num_samples, start, _end, cb, data, options)
end

"""
    vrna_pbacktrack_sub_resume(vc, num_samples, start, _end, nr_mem, options)
...
"""
    vrna_pbacktrack_sub_resume_cb(fc, num_samples, start, _end, bs_cb, data, nr_mem, options)
...
function vrna_pbacktrack_sub_resume_cb(fc, num_samples, start, _end, bs_cb, data, nr_mem, options)
    ccall((:vrna_pbacktrack_sub_resume_cb, libRNA), Cuint, (Ptr{vrna_fold_compound_t}, Cuint, Cuint, Cuint, Ptr{vrna_boltzmann_sampling_callback}, Ptr{Cvoid}, Ptr{vrna_pbacktrack_mem_t}, Cuint), fc, num_samples, start, _end, bs_cb, data, nr_mem, options)
end
...
function vrna_probs_window(fc, ulength, options, cb, data)
    ccall((:vrna_probs_window, libRNA), Cint, (Ptr{vrna_fold_compound_t}, Cint, Cuint, Ptr{vrna_probs_window_callback}, Ptr{Cvoid}), fc, ulength, options, cb, data)
end
...
function vrna_pfl_fold_cb(sequence, window_size, max_bp_span, cb, data)
    ccall((:vrna_pfl_fold_cb, libRNA), Cint, (Ptr{Cchar}, Cint, Cint, Ptr{vrna_probs_window_callback}, Ptr{Cvoid}), sequence, window_size, max_bp_span, cb, data)
end
...
function vrna_pfl_fold_up_cb(sequence, ulength, window_size, max_bp_span, cb, data)
    ccall((:vrna_pfl_fold_up_cb, libRNA), Cint, (Ptr{Cchar}, Cint, Cint, Cint, Ptr{vrna_probs_window_callback}, Ptr{Cvoid}), sequence, ulength, window_size, max_bp_span, cb, data)
end
...
function vrna_subopt_cb(fc, delta, cb, data)
    ccall((:vrna_subopt_cb, libRNA), Cvoid, (Ptr{vrna_fold_compound_t}, Cint, Ptr{vrna_subopt_callback}, Ptr{Cvoid}), fc, delta, cb, data)
end
